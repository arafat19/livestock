...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            ...
            <li><a href="<?php echo base_url(); ?>admin/instructor/create"><i class="fa fa-database"></i> Add Trainer</a></li>
            <li><a href="<?php echo base_url(); ?>admin/applicant/form/upload"><i class="fa fa-cloud-upload"></i> Upload Form</a></li>
