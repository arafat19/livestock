...
class Report extends CI_Controller
{
    ...
    function reportAppList()
    {
        ...
        for ($i = 0; $i < COUNT($applicant_name); $i++) {
            ...
            $applicantImg = FCPATH . "/uploaded/applicants_photo/" . $applicant_name[$i][0]->applicant_photo;
            ...
            $html .= '
                        <tr style="border-bottom: 1px solid #ddd;font-size:10px;">
                            <td style="border-bottom: 1px solid #ddd;font-size:12px;">' . $applicant_name[$i][0]->applicant_name . '</td>
                            <td style="border-bottom: 1px solid #ddd;font-size:12px;">' . $applicant_name[$i][0]->applicant_mobile . '</td>
                            <td style="border-bottom: 1px solid #ddd;font-size:12px;">' . $applicant_name[$i][0]->district_name . '</td>
                            <td style="border-bottom: 1px solid #ddd;font-size:12px;">' . $applicant_name[$i][0]->sub_district_name . '</td>
                            <td style="border-bottom: 1px solid #ddd;font-size:12px;">' . $applicant_name[$i][0]->applicant_village . '</td>
                            <td style="border-bottom: 1px solid #ddd;font-size:12px;">' . $applicant_name[$i][0]->course_name . '</td>
                            <td style="border-bottom: 1px solid #ddd;font-size:12px;">
                                <img style="width: 10mm; height: 10mm;" src="' . base_url() . 'uploaded/applicants_photo/' . $dImg . '" />
                            </td>
                        </tr>';
        }
