...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 09, 2017 at 09:50 PM
...
(34, 'আরাফাত', '25/10/2016', 'fdsf', 'fdsf', '01687127823', '', 'fsdfdsf', 'fdsfdsf', 2, 1, 5, '', 1, '2016-01-10', 0, 0, 0),
...
(53, 'zabeer', '20-08-2016', 'ibrahim', '1234567890', '01687127823', '', 'fdfsdsf', 'fdsfdsf', 1, 3, 5, '14837_824718484299364_9094606429871241501_n.jpg', 1, '2016-12-07', 0, 0, 0),
(54, 'sdffdsf', '15-12-2016', 'fsdfdsf', 'fdsfsdf', '01687127823', '', 'fsdfsf', 'fdsfdsf', 1, 3, 5, '11405237_3687038351358260_1125949205_n.png', 1, '2016-12-07', 0, 0, 0);
...
--
ALTER TABLE `blri_applicant`
  MODIFY `applicant_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
--
...
--
ALTER TABLE `blri_instructor`
  MODIFY `instructor_id` int(80) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
